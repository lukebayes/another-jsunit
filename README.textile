...
This is likely a problem with my own comprehension more than a problem with their implementation, so please only use this if you have also checked out the real "JSUnit":http://jsunit.net/!

...
This framework was developed over a weekend while working on a Rails application. I'm essentially sharing it because I think code should be shared. If you want changes made, fork, change it and send me a pull request. I'm not planning on creating a community around this because people seem to be satisfied with the existing JUnit.
